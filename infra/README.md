...
`portal_dp_worker`. Como a conexão ativa o papel lógico por `options=-c role=...`,
`RESET ROLE` restaura esse papel limitado; `SET ROLE NONE` volta ao login sem
privilégios próprios. Nenhum deles alcança o bootstrap. Nenhum processo web pode ser
